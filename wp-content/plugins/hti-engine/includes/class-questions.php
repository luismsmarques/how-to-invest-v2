...
class Questions {
	...
	private static function ui( string $l ): array {
		$s = array(
			...
			'processing_2'      => array( 'en' => 'Framing your profile…', 'pt' => 'A enquadrar o teu perfil…' ),
			'processing_3'      => array( 'en' => 'Building the example portfolio…', 'pt' => 'A montar o exemplo de carteira…' ),
			...
			'example_label'     => array( 'en' => 'Example', 'pt' => 'Exemplo' ),
			'by_classes'        => array( 'en' => 'by classes', 'pt' => 'por classes' ),
			...
			'email_result'      => array( 'en' => 'Email me my result', 'pt' => 'Enviar-me o resultado por email' ),
			'email_placeholder' => array( 'en' => 'your@email.com', 'pt' => 'o-teu@email.com' ),
			'email_send'        => array( 'en' => 'Send', 'pt' => 'Enviar' ),
			'email_sending'     => array( 'en' => 'Sending…', 'pt' => 'A enviar…' ),
			'email_sent'        => array( 'en' => 'Sent ✓ Check your inbox.', 'pt' => 'Enviado ✓ Vê a tua caixa de entrada.' ),
			'email_invalid'     => array( 'en' => 'Please enter a valid email.', 'pt' => 'Introduz um email válido.' ),
			'email_error'       => array( 'en' => 'Could not send. Please try again.', 'pt' => 'Não foi possível enviar. Tenta novamente.' ),
