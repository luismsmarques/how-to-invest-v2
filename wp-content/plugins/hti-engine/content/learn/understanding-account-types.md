...
slug_pt: perceber-os-tipos-de-conta
module: 4
order: 1
topic: getting-started
status: written
title_en: "Understanding account types"
...
---
<!-- EN -->
> Investments live inside an account, and the type you use mostly changes the tax treatment and the purpose — not what you can hold.
...
As pessoas imaginam muitas vezes "comprar investimentos" como sendo a história toda, mas há um recipiente à volta deles: uma conta. Perceber os tipos amplos — sem te perderes nos detalhes — torna o lado prático muito menos intimidante.

## A conta é o invólucro
